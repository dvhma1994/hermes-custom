...
param(
    [switch]$NoVenv,
    [switch]$SkipSetup,
    [string]$Branch = "live-improvements-2026-06-24-12h",
...
$RepoUrlSsh = "git@github.com:dvhma1994/hermes-custom.git"
$RepoUrlHttps = "https://github.com/dvhma1994/hermes-custom.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/dvhma1994/hermes-custom/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/dvhma1994/hermes-custom/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/dvhma1994/hermes-custom/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
